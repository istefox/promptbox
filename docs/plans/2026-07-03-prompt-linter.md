...
- [ ] **Task 1 — Placeholder-level malformed/conflict detection (L1, L2 foundations)**
...
- [ ] **Task 2 — Domain lint module: single-prompt rules, L6, orchestration**
...
- [ ] **Task 3 — Report modal and shared "open as note" helper**
...
- [ ] **Task 4 — Badge unification in the library view + command registration**
