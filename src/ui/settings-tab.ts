import { Notice, PluginSettingTab, setIcon, Setting, type App, type SettingDefinitionItem } from "obsidian";
 ...
 * private method shared by both paths, so the two never drift apart.
 */
